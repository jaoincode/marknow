      ...
      <div className="p-7 relative z-20">
        ...
        <div>
          ...
          <ul className="flex flex-col items-center gap-5 md:gap-6">
            <li className="h-12 w-full flex items-center pl-4 bg-mygray-200 rounded-lg text-mywhite-100 font-semibold md:max-w-lg md:h-14 md:text-lg text-md shadow-lg">
